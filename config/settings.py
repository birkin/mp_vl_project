...
"""
Django settings for mp_vl_project.
...
# template_dirs = json.loads( os.environ['MV_DJ__TEMPLATES_JSON'] )  # if template-directory info is complex
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ '%s/mp_vl_app' % BASE_DIR ],
        # 'DIRS': template_dirs,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
