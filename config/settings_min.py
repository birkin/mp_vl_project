...
SECRET_KEY = os.environ['MV_DJ__SECRET_KEY']

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = json.loads( os.environ['MV_DJ__DEBUG_JSON'] )  # will be True or False

ADMINS = json.loads( os.environ['MV_DJ__ADMINS_JSON'] )

ALLOWED_HOSTS = json.loads( os.environ['MV_DJ__ALLOWED_HOSTS'] )  # list
...
# template_dirs = json.loads( os.environ['MV_DJ__TEMPLATES_JSON'] )
# TEMPLATES = [
#     {
...
# DATABASES = json.loads( os.environ['MV_DJ__DATABASES_JSON'] )
...
# STATIC_URL = os.environ['MV_DJ__STATIC_URL']
# STATIC_ROOT = os.environ['MV_DJ__STATIC_ROOT']  # needed for collectstatic command
...
LOGGING = {
    ...
    'handlers': {
        'logfile': {
            ...
            'filename': os.environ.get(u'MV_DJ__LOG_PATH'),
            'formatter': 'standard',
        },
        'console':{
            'level':'DEBUG',
